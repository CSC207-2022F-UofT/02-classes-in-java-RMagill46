...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param s1 the first string for this Silly instance's name.
     * @param s2 the second string for this Silly instance's name that will be concatenated to s1.
     */
    ...
    public int compareTo(Silly other) {
        int compare = this.name.length() - other.name.length();
        return compare;
    }
